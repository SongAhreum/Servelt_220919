...
<style type="text/css">
 ...
 .nav-link:hover{color:#E5D1D1; text-decoration: none;}
 .goods-box{height:340px;width:340px; border: 2px solid coral; padding:10px; margin:10px}
 .goods-box:hover{backgraound-color:#E5D1D1;}
 .goods-image-box{height:210px}
 .title{font-weight:bold; font-size:1.5em}
 .price{color:gray}
 .nickname{color:coral}
</style>
...
<body>
	<div class="container">
		...
		<!-- contents -->
		<jsp:include page="/lesson04/quiz03/list_contents.jsp"/>
